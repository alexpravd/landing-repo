...
async function seedDemoData() {
  try {
    ...
    const tags = [
      {
        name: { uk: 'Інновації', en: 'Innovation' },
        slug: 'innovations',
        color: 'indigo',
        desc: {
          uk: 'Новини про інновації та технології',
          en: 'News about innovations and technology',
        },
      },
      {
        name: { uk: 'Бізнес', en: 'Business' },
        slug: 'business',
        color: 'blue',
        desc: { uk: 'Бізнес новини та економіка', en: 'Business news and economics' },
      },
      {
        name: { uk: 'Освіта', en: 'Education' },
        slug: 'education',
        color: 'green',
        desc: { uk: 'Новини освіти та навчання', en: 'Education and learning news' },
      },
      {
        name: { uk: 'Технології', en: 'Technology' },
        slug: 'technology',
        color: 'purple',
        desc: { uk: 'Технологічні новини', en: 'Technology news' },
      },
      {
        name: { uk: 'Наука', en: 'Science' },
        slug: 'science',
        color: 'teal',
        desc: { uk: 'Наукові дослідження та відкриття', en: 'Scientific research and discoveries' },
      },
      {
        name: { uk: 'Спільнота', en: 'Community' },
        slug: 'community',
        color: 'pink',
        desc: { uk: 'Новини спільноти', en: 'Community news' },
      },
      {
        name: { uk: 'Стартапи', en: 'Startups' },
        slug: 'startups',
        color: 'amber',
        desc: { uk: 'Новини стартапів', en: 'Startup news' },
      },
      {
        name: { uk: 'Дизайн', en: 'Design' },
        slug: 'design',
        color: 'red',
        desc: { uk: 'UI/UX та дизайн', en: 'UI/UX and design' },
      },
    ]
    ...
    const newsArticles = [
      {
        title: {
          uk: 'Штучний інтелект змінює освіту в Україні',
          en: 'Artificial Intelligence Transforms Education in Ukraine',
        },
      ...
      {
        title: {
          uk: 'Український стартап залучив $10 млн інвестицій',
          en: 'Ukrainian Startup Raises $10M Investment',
        },
      ...
      {
        title: {
          uk: 'Прорив у квантових обчисленнях: нова ера технологій',
          en: 'Quantum Computing Breakthrough: A New Era of Technology',
        },
      ...
      {
        title: {
          uk: 'Міжнародний хакатон TechForGood 2025',
          en: 'International Hackathon TechForGood 2025',
        },
      ...
      {
        title: {
          uk: 'Новий тренд у веб-дизайні: мінімалізм 2.0',
          en: 'New Web Design Trend: Minimalism 2.0',
        },
      ...
      {
        title: {
          uk: 'Блокчейн у державному управлінні: досвід Естонії',
          en: "Blockchain in Government: Estonia's Experience",
        },
      ...
      {
        title: {
          uk: 'Зелені технології: як стартапи рятують планету',
          en: 'Green Tech: How Startups Save the Planet',
        },
      ...
      {
        title: {
          uk: 'Майбутнє роботи: віддалена співпраця у 2025',
          en: 'The Future of Work: Remote Collaboration in 2025',
        },
      ...
      {
        title: {
          uk: 'Кібербезпека для малого бізнесу: практичні поради',
          en: 'Cybersecurity for Small Business: Practical Tips',
        },
      ...
      {
        title: {
          uk: 'Нейронні мережі у медицині: діагностика майбутнього',
          en: 'Neural Networks in Medicine: Diagnosis of the Future',
        },
      ...
      {
        title: {
          uk: 'Едтех революція: як навчаються нові покоління',
          en: 'EdTech Revolution: How New Generations Learn',
        },
      ...
      {
        title: {
          uk: 'Фінтех тренди 2025: що чекає на банківський сектор',
          en: 'Fintech Trends 2025: What Awaits the Banking Sector',
        },
      ...
      {
        title: {
          uk: 'Космічні технології: приватні компанії виходять на орбіту',
          en: 'Space Tech: Private Companies Reach Orbit',
        },
      ...
      {
        title: {
          uk: 'UX/UI тренди 2025: користувацький досвід нового рівня',
          en: 'UX/UI Trends 2025: Next-Level User Experience',
        },
      ...
      {
        title: {
          uk: 'Віртуальна реальність у навчанні: досвід провідних університетів',
          en: "Virtual Reality in Education: Leading Universities' Experience",
        },
      ...
      {
        title: {
          uk: 'Етичний ШІ: як забезпечити відповідальність алгоритмів',
          en: 'Ethical AI: How to Ensure Algorithm Accountability',
        },
      ...
      {
        title: {
          uk: 'Соціальні мережі майбутнього: децентралізація та приватність',
          en: 'Social Networks of the Future: Decentralization and Privacy',
        },
      ...
      {
        title: {
          uk: 'Агротех: як технології змінюють сільське господарство',
          en: 'AgriTech: How Technology Transforms Agriculture',
        },
      ...
      {
        title: {
          uk: 'Майбутнє транспорту: електромобілі та автономні авто',
          en: 'Future of Transportation: Electric and Autonomous Vehicles',
        },
      ...
      {
        title: {
          uk: 'Нові тренди в кібербезпеці: підготовка до загроз 2025',
          en: 'New Cybersecurity Trends: Preparing for 2025 Threats',
        },
    ...
    const homePage = await payload.create({
      ...
      data: {
        ...
        blocks: [
          {
            ...
            description:
              'Ми створюємо сучасні рішення для цифрової трансформації бізнесу та освіти',
            badge: {
              text: 'Платформа',
              icon: 'Sparkles',
        ...
        seo: {
          ...
          metaDescription:
            'Сучасна платформа для цифрової трансформації бізнесу та освіти. Новини, інновації, технології.',
    ...
    await payload.update({
      ...
      data: {
        ...
        blocks: [
          {
            ...
            description:
              'We create modern solutions for digital transformation of business and education',
            badge: {
              text: 'Platform',
              icon: 'Sparkles',
              gradient: 'indigo-to-purple',
        ...
        seo: {
          ...
          metaDescription:
            'Modern platform for digital transformation of business and education. News, innovations, technology.',
    ...
    const newsPage = await payload.create({
      ...
      data: {
        ...
        seo: {
          ...
          metaDescription:
            'Новини про інновації, технології, бізнес та освіту. Останні події та тренди.',
    ...
    await payload.update({
      ...
      data: {
        ...
        seo: {
          ...
          metaDescription:
            'News about innovations, technology, business, and education. Latest events and trends.',
        ...
        children: [
          {
            ...
            items: [
              ...
              {
                label: tags[0].name.uk,
                linkType: 'page',
                page: categoryPages[0].id,
                openInNewTab: false,
              },
              {
                label: tags[1].name.uk,
                linkType: 'page',
                page: categoryPages[1].id,
                openInNewTab: false,
              },
              {
                label: tags[2].name.uk,
                linkType: 'page',
                page: categoryPages[2].id,
                openInNewTab: false,
              },
              {
                label: tags[3].name.uk,
                linkType: 'page',
                page: categoryPages[3].id,
                openInNewTab: false,
              },
            ],
          },
        ...
        children: [
          {
            ...
            items: [
              ...
              {
                label: tags[0].name.en,
                linkType: 'page',
                page: categoryPages[0].id,
                openInNewTab: false,
              },
              {
                label: tags[1].name.en,
                linkType: 'page',
                page: categoryPages[1].id,
                openInNewTab: false,
              },
              {
                label: tags[2].name.en,
                linkType: 'page',
                page: categoryPages[2].id,
                openInNewTab: false,
              },
              {
                label: tags[3].name.en,
                linkType: 'page',
                page: categoryPages[3].id,
                openInNewTab: false,
              },
    ...
    console.log(
      `   - News Articles: ${createdNewsArticles.length} created (19 published, 1 draft, bilingual UA/EN)`
    )
